...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Edytowanie stanowiska') }}</div>
                    <div class="card-body">
                        <form method="POST" action="{{route('position.edit',[$position->id])}}" >
                            @csrf
                            <input type="hidden" name="id" value="{{$position->id}}">
                            <div class="row mb-1">
                                <label for="stanowisko" class="col-md-4 col-form-label text-md-right">{{ __('Nazwa stanowisa') }}</label>
                                <div class="col-md-6">
                                    <input id="stanowisko"  type="text" class="form-control @error('stanowisko') is-invalid @enderror" name="stanowisko" value="{{ old('stanowisko',$position->stanowisko) }}">
                                ...
                                <div class="col-md-6">
                                    <select id="poziom_dostepu" type="text" class="form-control @error('poziom_dostepu') is-invalid @enderror" name="poziom_dostepu">
                                        @foreach($types as $type)
                                            <option @selected(old('poziom_dostepu',$position->poziom_dostepu)==$type) value='{{$type}}'>{{$type}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input id="chemia" type="checkbox" class="form-check  @error('chemia') is-invalid @enderror" name="chemia" value="1" @checked(old('chemia',$position->chemia))>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input id="halas" type="checkbox" class="form-check  @error('halas') is-invalid @enderror" name="halas" value="1" @checked(old('halas',$position->halas))>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input id="inne" type="checkbox" class="form-check @error('inne') is-invalid @enderror" value="1" name="inne" @checked(old('inne',$position->inne))  >
                            ...
                            <div class="row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    ...
                                    <button type="submit" class="btn btn-primary">{{ __('Edytuj stanowisko') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
