...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Tworzenie konta pracownika') }}</div>
                    ...
                    <form method="POST" action="{{ route('user.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                @error('name')
                                    <span class="invalid-feedback" role="ale
                        ...
                        <div class="row mb-3">
                            <label for="stanowisko" class="col-md-4 col-form-label text-md-right">{{ __('Stanowisko') }}</label>

                            <div class="col-md-6">

                              <select id="stanowisko" class="form-control @error('stanowisko') is-invalid @enderror" name="stanowisko" value="{{ old('stanowisko') }}"  autocomplete="stanowisko" autofocus>
                                @foreach($users as $user)
                                <option value='{{$user->id}}'>{{$user->stanowisko}}</option>
                                @endforeach
                              </select>
                                @error('stanowisko')
                                    <span class="invalid-feedback" role="alert">
